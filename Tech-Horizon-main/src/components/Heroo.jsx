...
const Heroo = () => {
  ...
  return (
    <motion.section
      id="home"
      ref={sectionRef}
      className="h-[750px] md:h-[950px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_0%,black_100%,transparent)]"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="absolute h-8 w-8 right-1/2 bg-white rounded-full top-full -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute h-5 w-5 left-1/2 bg-white rounded-full top-0 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute h-7 w-7 left-full border border-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center">
      ...
      >
        ...
        <div className="absolute h-8 w-8 left-0 border border-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center">
          <div className="h-2 w-2 bg-white rounded-full"></div>
        </div>
      </motion.div>
      {/* End Ring 3 */}
      ...
      <div className="container relative mt-16">
        <h1 className="text-[60px] md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">
          TechHorizon
        </h1>
        <p className="text-md md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          Code your way to the stars. Join one of the biggest tech event of the year.
        </p>
        <div className="flex justify-center z-50 mt-5">
          ...
          <iframe
            ...
            className="w-full h-[500px] border-0 p-0 m-0 md:h-[550px]"
